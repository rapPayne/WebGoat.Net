...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="owaspTopTen">
        ...
        <div>
            Welcome to WebGoat.Net, an intentionally insecure ecommerce website created
            so that you and I can learn to create intentionally secure websites. We've introduced
            vulnerabilities covering the OWASP Top Ten as well as several others.
        </div>
        <div>
    ...
    <div class="owaspTopTen">
        ...
        <div>
            ...
            used to life session cookies by tricking the user into calling
            http://localhost:666/StealCookie.aspx?Cookie=[Enter cookie value here].</div>
    </div>
    <div class="owaspTopTen">
        <h2>
        ...
        <div>
            ...
            (is the request for a sensitive page coming from the same IP where the user 
            logged in?)&nbsp; But the only sure-fire hardening for session-stealing is 
            asking the user to re-authenticate on sensitive pages.&nbsp;
        </div>
    </div>
    <div class="owaspTopTen">
        <h2>
        ...
        <div>
            Customers can edit their own info via EditCustomer.aspx/ID=12345. Hackers
            can change the ID to edit another customer's info. We can harden against this by checking the identity; if currentUser == ID, let them continue.
            Otherwise deny.
        </div>
    </div>
    <div class="owaspTopTen">
        ...
        <div>
            In the Evil site, there is a page 
            (http://localhost:666/CSRF.html) that mounts a CSRF attack.&nbsp; If
            the user surfs to it while he is logged in on the legitimate site, it will load his cart
            with a particular product and check out using the logged-in user&#39;s credentials.&nbsp;
            To protect against this, add a CAPTCHA to the checkout page.</div>
    </div>
    <div class="owaspTopTen">
        <h2>
    ...
    <div class="owaspTopTen">
        ...
        <div>
            Currently, any unhandled
            error flows through to the YSOD (The APS.NET Yellow Screen of Death). This 
            exposes our stack and would allow for an automated attack.&nbsp; To harden 
            against this, we should create a custom error page and edit web.config to show 
            this generic error page whenever any 500-series error is encountered.</div>
    </div>
    <div class="owaspTopTen">
        <h2>
            Clickjacking</h2>
    ...
    <div class="owaspTopTen">
        <h2>
            Phishing</h2>
        <div>
            A successful phishing attacker will trick the victim into clicking on a link 
            that points to his evil website and tricking the victim into typing in personal 
            information. Although there&#39;s nothing that a developer can do to prevent this, 
            we can make it more obvious that the attacker&#39;s URL is bogus.&nbsp; We do this 
            by making our URLs less complex. To help with that, we can make the URLs less complicated by creating routes in global.asax in a register routes
            method.</div>
    </div>
    <div class="owaspTopTen">
        <h2>
