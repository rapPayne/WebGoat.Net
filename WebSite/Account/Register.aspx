                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:TextBox ID="CompanyName" ClientIDMode="Static" runat="server" CssClass="textEntry"></asp:TextBox>
                        ...
                        <fieldset class="login">
                            ...
                            <br />
                            <asp:Label ID="Label2" runat="server" Text="Region/State"></asp:Label><br />
                            <asp:TextBox ID="txtRegion" runat="server" CssClass="textEntry"></asp:TextBox>
                            <br />
                            <asp:Label ID="Label3" runat="server" Text="Postal Code"></asp:Label><br />
                            <asp:TextBox ID="txtPostalCode" runat="server" CssClass="textEntry"></asp:TextBox>
                            <br />
